          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="flex flex-col items-center text-center text-white border-4 border-[#1368c8] rounded-[10px] p-6">
              ...
              <p className="text-[#00cb75] text-[16px] leading-relaxed mb-8">
                Get more value out of our leads. If there are neighboring houses
                at one of these inspections, knock on the door and let them know
                you’re working in the area. Offer a free inspection, and this
                may turn into a new client.
              </p>
            ...
            <div className="flex flex-col items-center text-center text-white border-4 border-[#1368c8] rounded-[10px] p-6">
              ...
              <p className="text-[#00cb75] text-[16px] leading-relaxed mb-8">
                When you call ahead, you give them the opportunity to cancel the
                appointment. Show up at the appointed time. If they’re not home,
                then you can call. If you call ahead of time and they cancel, we
                cannot reimburse for this.
              </p>
            ...
            <div className="flex flex-col items-center text-center text-white border-4 border-[#1368c8] rounded-[10px] p-6">
              ...
              <p className="text-[#00cb75] text-[16px] leading-relaxed mb-8">
                ...
                campaign. Do your research and pick the best areas to advertise.
                We want you to be successful, so it’s in both of our best
                interest if you make the best decisions when campaigning with
                us.
              </p>
            ...
            <div className="flex flex-col items-center text-center text-white border-4 border-[#1368c8] rounded-[10px] p-6">
              ...
              <p className="text-[#00cb75] text-[16px] leading-relaxed mb-8">
                When we schedule appointments with potential customers, they’re
                going to expect you there on time. To ensure your own success,
                provide us with the times you’re most available, and we’ll
